...
use BurntShake\Api\Customizer\Sidebar;
use BurntShake\Api\Customizer\Header;
use BurntShake\Api\Customizer\Footer;
...
class Customizer
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'burnt-shake_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'burnt-shake_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'burnt-shake_header_background_color' );
			echo self::css( '.site-header', 'color', 'burnt-shake_header_text_color' );
			echo self::css( '.site-header a', 'color', 'burnt-shake_header_link_color' );
